  ...
  def GetBatchedResultArray(self, batched_result_dict, batch_size):
    if (batch_size != len(batched_result_dict["output_flag"])):
      ...
      for i in range(batch_size):
        result_dict = dict()
        result_dict["output_flag"] = batched_result_dict["output_flag"][i]
        result_dict["tform_params"] = batched_result_dict["tform_params"][i]
        result_dict["cropped_image"] = batched_result_dict["cropped_image"][i]
