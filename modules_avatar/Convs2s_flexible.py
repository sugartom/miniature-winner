...
class Convs2s:
    ...
    @staticmethod
    def Setup():
        args_T2T = ["--config_file=/home/yitao/Documents/fun-project/tensorflow-related/miniature-winner/OpenSeq2Seq/example_configs/text2text/en-de/en-de-convs2s-8-gpu.py",
                    "--mode=tf_serving_infer",
                    "--batch_size_per_gpu=1",
                    ]
        Convs2s.model = get_model(args_T2T, "conv_s2s")
    ...
    def PreProcess(self, request_input, istub, grpc_flag):
        ...
        self.istub = istub
        self.feed_dict = Convs2s.model.get_data_layer().create_feed_dict([self.request_input])
    ...
    def Apply(self):
        ...
        internal_request.model_spec.name = 'conv_s2s'
