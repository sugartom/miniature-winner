...
while frame_num:
    ...
    if ret == 0:
        ...
        break
    if out is None:
        out = cv2.VideoWriter('/home/yitao/Documents/fun-project/tensorflow-related/miniature-winner/outputs/face_pipeline_output.avi', cv2.cv.CV_FOURCC(
    ...
    # print(tensor_util.MakeNdarray(prnet_request.inputs["bounding_box"]))
    # break
    ...
    if "bounding_box" in prnet_request.inputs:
        ...
        # print(tensor_util.MakeNdarray(next_request.inputs["tform_params"]).shape)
        # print(tensor_util.MakeNdarray(next_request.inputs["cropped_image"]).shape)
        # break
